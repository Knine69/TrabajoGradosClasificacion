...
docker build --platform=linux/amd64 -f chroma/Dockerfile -t chroma-executor .
...
docker build --platform=linux/amd64  -f user_langchain/Dockerfile -t langchain-executor .
